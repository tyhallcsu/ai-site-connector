...
require_file 'ai-site-connector/includes/class-openapi.php'
require_file 'ai-site-connector/includes/class-discovery.php'
require_file 'ai-site-connector/examples/mcp-server/package.json'
require_file 'ai-site-connector/examples/mcp-server/index.mjs'
require_file 'ai-site-connector/examples/mcp-server/README.md'
